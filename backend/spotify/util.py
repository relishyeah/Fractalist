...
def refresh_spotify_token(session_id):
    ...
    print(refresh_token)
    print()
    headers = {"Accept": "application/json", "Content-Type": "application/json", "Authorization":"Basic " + CLIENT_ID +':' + CLIENT_SECRET }
    response =  post('https://accounts.spotify.com/token', data ={
